...
srun --mpi=pmi2 Rscript /home/mcallen/blra_pred/ensp_ebird_cell_predict_yrcon_for_Amarel.R IFN:/scratch/mcallen/blra_pred/ensp_ebird_cell_predict_out_yrcon.csv
