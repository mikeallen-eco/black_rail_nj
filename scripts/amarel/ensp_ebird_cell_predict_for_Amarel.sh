...
#SBATCH --job-name=ensp_ebird_cell_predict ## Replace with your jobname 
...
srun --mpi=pmi2 Rscript /scratch/mcallen/blra_pred/ensp_ebird_cell_predict_for_Amarel.R IFN:/scratch/mcallen/blra_pred/ensp_ebird_cell_predict_out_dur.csv