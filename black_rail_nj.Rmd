...
ggsave("figures/Fig2_ownership_of_rail_habitat_bw4_fixed2.pdf", height = 5, width = 6.25, dpi = 600)
...
```
# Correlation between mapped predictions of 'continous year' and 'categorical year' models
```{r}

cata <- read.csv("D:/black_rail/big_output_2021_10/csv/ensp_ebird_cell_predict_out_summary_dur.csv")

cont <- read.csv("D:/black_rail/big_output_2022_07/ensp_ebird_cell_predict_out_yrcon.csv")

plot(cata$med ~ cont$q50)

cor(cata$med, cont$q50) # 0.9968038
